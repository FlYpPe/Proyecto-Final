...
/*
	public boolean agregarAlumno(Alumno a) {
		String sql = "insert into Alumnos Values('" + a.getNumControl() + "','" + a.getPrimerAp() + "','"
				+ a.getNombre() + "','" + a.getSegundoAp() + "'," + a.getEdad() + "," + a.getSemestre() + ",'"
				+ a.getCarrera() + "')";
	...
	public boolean modificarAlumno(Alumno a) {
		...
		String sql = "Update Alumnos Set Nombre_Alumno= '" + a.getNombre() + "'" + ", Primer_Ap_Alumno = '"
				+ a.getPrimerAp() + "'" + ", Segundo_Ap_Alumno = '" + a.getSegundoAp() + "'" + ", Edad_Alumno = "
				+ a.getEdad() + "" + ", Semestre = " + a.getSemestre() + "" + ", Carrera = '" + a.getCarrera()
...
//		Nombre_Alumno | Primer_Ap_Alumno | Segundo_Ap_Alumno | Edad_Alumno | Semestre | Carrera
	...
	public Alumno buscarAlumno(String numControl) {
		...
		try {
			...
			return new Alumno(res.getString("Num_Control"), res.getString(2), res.getString(3), res.getString(4),
					res.getByte(5), res.getByte(5), res.getString(6));
